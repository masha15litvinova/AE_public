//Library to control the motors of the platform
#include <Arduino.h>


//motors pins (Enable, InA, InB, PWM)
#define MOTOR1_EN 6
...
//function to initialize all motors of platform
...
//function to control motors of the platform
